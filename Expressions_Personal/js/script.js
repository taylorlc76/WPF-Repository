...
var transitions = prompt("How many transitions will there be during the show?"); //this allows for the user to tell me the amount of transitions during the show needed to change up makeup
